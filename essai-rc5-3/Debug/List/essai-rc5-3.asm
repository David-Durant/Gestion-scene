...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	.DEF _basculeBitValeur=R4
	.DEF _basculeBitValeur_msb=R5
	.DEF __lcd_x=R7
	.DEF __lcd_y=R6
	.DEF __lcd_maxx=R9
...
_0x0:
	.DB  0x74,0x65,0x73,0x74,0x20,0x72,0x63,0x35
	.DB  0x20,0x63,0x6D,0x64,0x20,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0047     rc5Bit1L();     // adresse bit 4    adresse=0x14 (20 en décimal)
...
; 0000 0058     rc5Bit1L();     // adresse bit 4    adresse=0x14 (20 en décimal)
	RCALL _rc5Bit1L
...
; 0000 00CF     rc5Bit1L();     // adresse bit 4    adresse=0x14 (20 en décimal)
...
; 0000 00E0     rc5Bit1L();     // adresse bit 4    adresse=0x14 (20 en décimal)
...
; 0000 00F1     rc5Bit1L();     // adresse bit 4    adresse=0x14 (20 en décimal)
